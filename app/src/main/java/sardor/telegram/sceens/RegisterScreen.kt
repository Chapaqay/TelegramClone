...
import sardor.telegram.ui.theme.Background
import sardor.telegram.ui.theme.Black20
import sardor.telegram.ui.theme.Primary
import sardor.telegram.ui.theme.Secondary
import sardor.telegram.ui.theme.Text2
...
fun RegisterScreen(navController: NavController){
    ...
    Column (
        ...
        TextField(value = fullName.value,
            ...
            label = { Text(text = "Fullname", fontSize = 14.sp) },
            leadingIcon = {
                Icon(
        ...
        Button(
            ...
            shape = RoundedCornerShape(16.dp),
            colors = ButtonDefaults.buttonColors(containerColor = Primary, disabledContainerColor = Secondary)
